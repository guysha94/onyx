...
from ee.onyx.configs.app_configs import MIRO_PERMISSION_DOC_SYNC_FREQUENCY  # FORK: miro
from ee.onyx.configs.app_configs import (  # FORK: miro
    MIRO_PERMISSION_GROUP_SYNC_FREQUENCY,
)
...
from ee.onyx.external_permissions.miro.doc_sync import miro_doc_sync  # FORK: miro
from ee.onyx.external_permissions.miro.group_sync import miro_group_sync  # FORK: miro
...
_SOURCE_TO_SYNC_CONFIG: dict[DocumentSource, SyncConfig] = {
    ...
    # FORK: miro — team-based ACL: doc sync tags each asset with its board's
    # team external group; cc-pair-agnostic group sync resolves teams -> emails.
    DocumentSource.MIRO: SyncConfig(
        doc_sync_config=DocSyncConfig(
            doc_sync_frequency=MIRO_PERMISSION_DOC_SYNC_FREQUENCY,
            doc_sync_func=miro_doc_sync,
            initial_index_should_sync=False,
        ),
        group_sync_config=GroupSyncConfig(
            group_sync_frequency=MIRO_PERMISSION_GROUP_SYNC_FREQUENCY,
            group_sync_func=miro_group_sync,
            group_sync_is_cc_pair_agnostic=True,
        ),
    ),
